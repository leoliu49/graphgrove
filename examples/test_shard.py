...
d = np.load('/drive_sdc/msmarco-mpnet/shards/mpnet-msmarco-train-embeddings-default-768-shard-4.npz')
P = d['passage_embeddings'][:1000]
Q = d['query_embeddings'][:10]
...
ct.dump_tree('MSMARCO_1000x10_base_1.3.json')

print('Test k-Nearest Neighbours - Exact (k=1): ')
t = gt()
idx1, d1 = ct.NearestNeighbour(Q, use_multi_core=cores, filename='MSMARCO_1000x10_base_1.3.trace')
b_t = gt() - t
